...
/* GET PAGINADO Params => page, size */
export const PAGINATION_EXTERNAL_CORRESPONDENCE_PENDING = `${config.IP}:${config.PORT}/api/sgdea/service/external/correspondence/received/pagination/pending/to/do`;
/* POST */
